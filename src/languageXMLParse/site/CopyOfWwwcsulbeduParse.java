...
public class CopyOfWwwcsulbeduParse extends WebCrawler {
    ...
    public void visit(Page page) {   
    	try{
            if (page.getParseData() instanceof HtmlParseData) {
                    ...
                    Elements contents_html = doc.select(".group-footer h2 p");
                    if(!contents_html.isEmpty()&&!(doc.select(".field-name-title h1").isEmpty())){
