...
public class WwwcsucsbeduParse extends WebCrawler {
   ...
   // private final static String URL_PREFIX = "http://ti.tibet3.com/";
	...
	private final static String URL_PREFIX = "http://www.cs.ucsb.edu/people/";
    ...
    public void visit(Page page) {   
    	try{
            if (page.getParseData() instanceof HtmlParseData) {
                    ...
                    Elements contents_html = doc.select("p");
                    Elements contents_html1 = doc.select(".field-name-title h1");
                    if(!contents_html.isEmpty()&&!(contents_html1.isEmpty())){
                    String title =doc.select(".field-name-title h1").text();
